...
var payment = JSON.parse(localStorage.getItem("payment")) || [];
 ...
 function updateCheckoutSection(arr){
     ...
     document.querySelector("#total_number_of_cart_items").textContent = "Cart Value"+"("+arr.length+" x items"+")";

     // document.querySelector("#total_number_of_cart_items").textContent ="Cart Value";


     document.querySelector("#itemno").textContent="("+arr.length+" "+"ITEMS"+")";
